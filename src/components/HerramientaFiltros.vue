    ...
    <div class="botones-filtros">
      <div class="categoria-boton">
        ...
        >
          ...
          <option value="Polygender">No binario</option>
        </select>
      </div>
      <div class="categoria-boton">
        ...
        >
          ...
          <option value="55-59">60-64</option>
          <option value="55-59">65-69</option>
          <option value="55-59">70-74</option>
          <option value="55-59">75-79</option>
        </select>
      </div>
      <div class="categoria-boton">
      ...
      <div class="categoria-boton">
        ...
        >
          ...
          <option value="14+">Posdoctorado</option>
        </select>
      </div>
    </div>
  </div>
...
function setFiltros() {
  ...
  filtros_dict.value = {
    ...
    mayor_grado: seleccion_estudios.value,
  };
